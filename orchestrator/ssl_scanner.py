...
def execute_testssl(targets, output_dir=None):
    if not targets:
        return
...
def run_ssl_automation(subnet=None, subnets=None, output_dir=None):
    ...
    execute_testssl(all_targets, output_dir=output_dir)
