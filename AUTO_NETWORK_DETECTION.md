...
- Scans suitable active physical/private interfaces
- Excludes loopback, Docker, CNI, bridge, veth, and similar virtual interfaces
...
- Uses "quick" scan profile (top 100 ports)
